...
class ProductControllerTest extends RestDocsSupport {
    ...
    void getProduct() throws Exception {
        // given
        Long productId = 1L;
        ProductOption productOption1 = generateProductOption(1L, Size.L, Color.BLACK);
        ProductOption productOption2 = generateProductOption(2L, Size.M, Color.BLACK);
        ProductOption productOption3 = generateProductOption(3L, Size.S, Color.BLACK);
        ProductImage productImage1 = generateProductImage(1L, true, 1L, "TEST_PRODUCT_IMAGE1.PNG");
        ProductImage productImage2 = generateProductImage(2L, false, 2L, "TEST_PRODUCT_IMAGE2.PNG");
        ProductImage productImage3 = generateProductImage(3L, false, 3L, "TEST_PRODUCT_IMAGE3.PNG");
    ...
    private ProductImage generateProductImage(long productImageId, boolean basicYn, long fileId, String originFileName) {
    ...
    private ProductOption generateProductOption(long productOptionId, Size size, Color color) {
